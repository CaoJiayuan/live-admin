  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-8">
      ...
      <ol class="breadcrumb">
        ...
        <li>
          <a href="/admin/groups">团队经理列表</a>
        </li>
        <li class="active"><strong>{{ $item ? '修改' : '添加' }}团队经理</strong></li>
      </ol>
    </div>
    <div class="col-lg-4">
      <div class="title-action">
        <button class="button btn btn-info" type="submit" form="data-form">保存</button>
        <a href="/admin/groups" class="button btn btn-default">返回</a>
      </div>
    </div>
  </div>
@endsection
