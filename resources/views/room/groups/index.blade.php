  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-8">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><strong>团队列表</strong></li>
      </ol>
    </div>
  </div>
@endsection
      ...
      @foreach($data as $item)
        <tr>
          ...
          <td>
            ...
            <button class="btn btn-xs btn-danger delete" data-url="/room/groups/{{ $item->id }}">删除</button>
          </td>
        </tr>
      @endforeach
      </tbody>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" data-action="/room/groups/create" id="data-form">
            {{ csrf_field() }}
